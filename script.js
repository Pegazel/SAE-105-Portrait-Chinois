  ...
  fetch('data.json').then(function (response) {
    response.json().then(function (data) {
      ...
      function ajouteanal(script) {
        //Page d'accueil
        document.querySelector("#PageAccueil").innerHTML = '<h1><a href="#Accueil" class="titre" id=Accueil> <span class="M">M</span>on <span class="portrait">portrait</span> chinois</a></h1>  <p>Un portrait chinois est un jeu permettant de déceler certains aspects de la personnalité d’un individu ou de connaître ses goûts ou ses préférences personnelles, au travers d’un questionnaire basé sur l’identification à des personnes, des objets ou des éléments divers.</p>  <a href="#Pays"><img class="fleche" src="images/fleche.png" alt="" ></a> <a href="#Accueil" id=Accueil><img class="maison" src="images/Accueil.png" alt="" ></a><div class ="navbar"><a href="#Pays">Pays</a><br><a href="#Fruit">Fruit</a><br><a href="#Objet">Objet</a><br><a href="#Saison">Saison</a><br><a href="#Voiture">Voiture</a><br><a href="#Invention">Invention</a><br><a href="#Animal">Animal</a></div>'

        // Affichage des différentes analogies
        var texte = "";
        script.forEach(function afficheAnalogie(script) {
          texte += '<section class="' + script.classe + '"id="' + script.classe + '"><h2 class="' + script.classe + '"> Si j’étais <span class="analogie">' + script.analogie + '</span>,  je serais <span class="analogie">' + script.valeuranalogies + '</span></h2><div class="fond"><img class="' + script.classe + '" src="' + script.imagefond + '"></div><img class="' + script.classeimg + '" src="' + script.img + '"alt="' + script.alt + '"><p>' + script.justify + '</p></section>';
